...
import com.example.cse226unit4database.DatabaseHelper.Companion

class DatabaseHelperKO002(context: Context) : SQLiteOpenHelper(context,DATABASE_NAME, null,DATABASE_VERSION) {
    companion object {
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        db.execSQL("DROP TABLE IF EXISTS ${com.example.cse226unit4database.DatabaseHelperKO002.TABLE_NAME}")
        onCreate(db)
    }
